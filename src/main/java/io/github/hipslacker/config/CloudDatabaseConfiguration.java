package io.github.hipslacker.config;
...
@Configuration
@EnableMongoRepositories("io.github.hipslacker.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.hipslacker.config.dbmigrations");
